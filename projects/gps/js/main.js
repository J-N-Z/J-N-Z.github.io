; (function () {
    ...
    function setPointPos(leftPos) {
      ...
      let fillVal = Math.floor(leftPos / (slider.offsetWidth / range.end));
      input.innerText = fillVal;
      point.style.left = leftPos + 'px';
      slider.style.background = 'linear-gradient(to right, transparent, transparent 2.5%, #fade41 2.5%, #fade41 ' + fillVal + '%, transparent ' + fillVal + '%)';
    }
